        ...
        <div class="container">
            ...
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="text-center mb-4">Get in touch with us quickly and easily using our contact form. We’re here to answer your questions and assist you with your photography needs. </p>
                    <form>
                        <div class="row g-3">
                            <div class="col-md-6">
