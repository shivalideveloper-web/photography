    ...
    <div class="container-fluid hero-header bg-light py-5 mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <p class="text-primary text-uppercase mb-2 animated slideInDown">Welcome To FocusFrame Studio</p>
                  <h1 class="display-4 mb-3 animated slideInDown">
    FocusFrame Studio 
</h1>
<p class="animated slideInDown">
    Capturing the moments that matter most—authentically, artfully, and with heart. 
    From intimate elopements to timeless portraits, our Australia-based studio blends 
    storytelling and creativity to create images you’ll cherish for a lifetime. 
    Every session is crafted with care, emotion, and an eye for the details that make 
    your story uniquely yours.
                    ...
                    <div class="d-flex align-items-center pt-4 animated slideInDown">
                        <a href="{{ route('service') }}" class="btn btn-primary py-3 px-4 me-5">Explore More</a>
                ...
                <div class="col-lg-6 animated fadeIn">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white p-3 w-100 mb-3" src="{{asset('frontend/assets/img/hero-1.jpg')}}" alt="">
                            <img class="img-fluid bg-white p-3 w-50" src="{{asset('frontend/assets/img/hero-3.jpg')}}" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white p-3 w-50 mb-3" src="{{asset('frontend/assets/img/hero-4.jpg')}}" alt="">
...
<div class="row g-2 mb-4">
    ...
    <div class="col-sm-6">
        <i class="fa fa-check text-primary me-3"></i>Home Delivery Options
                        ...
                        <a class="btn btn-primary py-3 px-5" href="{{ route('about') }}">Read More</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-5.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-5.jpg')}}" data-lightbox="project">
                                    Memory
                                </a>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-1.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-1.jpg')}}" data-lightbox="project">
                                    Wedding
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-2.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-2.jpg')}}" data-lightbox="project">
                                    Portrait
                                </a>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-6.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-6.jpg')}}" data-lightbox="project">
                                    Travel
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-7.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-7.jpg')}}" data-lightbox="project">
                                    Wedding
                                </a>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-3.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-3.jpg')}}" data-lightbox="project">    
                                    Memory
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-4.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-4.jpg')}}" data-lightbox="project">
                                    Fashion
                                </a>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="{{asset('frontend/assets/img/project-8.jpg')}}" alt="">
                                <a class="project-title h5 mb-0" href="{{asset('frontend/assets/img/project-8.jpg')}}" data-lightbox="project">
                                    Portrait
                                </a>
                            </div>
                        </div>
                ...
                <div class="row g-0 flex-lg-row-reverse">
                    ...
                    <div class="col-sm-6">
                        <div class="h-100 p-5 d-flex flex-column justify-content-between">
                            ...
                            <p>    Richard perfects every image with meticulous attention to detail, enhancing colors, tones, and textures to bring each photo to life.
</p>
                            <div class="d-flex">
                                <a class="btn btn-square btn-outline-primary rounded-circle me-2" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary rounded-circle me-2" href=""><i class="fab fa-twitter"></i></a>
            ...
            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="row g-0 flex-sm-row-reverse">
                    ...
                    <div class="col-sm-6">
                        <div class="h-100 p-5 d-flex flex-column justify-content-between">
                            <div class="mb-3">
                                <h4>Creative Photograher And Videographer
</h4>
                                <span>Editor</span>
                            </div>
                            <p>    Olivia brings stories to life through precise editing, ensuring every video and image looks polished, seamless, and visually stunning.
</p>
                            <div class="d-flex">
                                <a class="btn btn-square btn-outline-primary rounded-circle me-2" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-outline-primary rounded-circle me-2" href=""><i class="fab fa-twitter"></i></a>
